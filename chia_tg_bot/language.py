...
russian = {"chia_stat":"Статус Chia","get_balance":"Узнать баланс",
        ...
        "current":"Текущее значение: ","type":"Набери: ","paral_diap":"Диапазон от 1 до 10",
...
english = {'chia_stat': 'Chia status', 'get_balance': 'Show balance', 'den': 'day', 'dnya': 'days', 'dney': 'days', 
        ...
        'wd_off': 'Disabled Watchdog.', 'current': 'Present value:', 'type': 'Charge:', 'paral_diap': 'Range from 1 to 10', 'num_paral_plots': 'The number of parallel plots:', 
